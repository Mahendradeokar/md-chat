    ...
    <div className="bg-background flex min-h-screen items-center justify-center p-6">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-2 text-center">
          <CardTitle className="text-2xl">Welcome to AUM</CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-6">
          <Button
            ...
            className="group bg-primary hover:bg-primary/90 relative h-12 w-full overflow-hidden text-base font-medium"
            variant="outline"
            disabled={loading}
          >
